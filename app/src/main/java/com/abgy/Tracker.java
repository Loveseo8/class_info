...
public class Tracker {
    ...
    private void loadFromImage(ImageTracker tracker, String path, String name) {
        ...
        if (target == null) {
            Log.e("Tracker", "target create failed");
            return;
        }
        ...
        tracker.loadTarget(target, scheduler, new FunctorOfVoidFromTargetAndBool() {
            ...
            public void invoke(Target target, boolean status) {
                Log.i("Tracker", String.format("load target (%b): %s (%d)", status, target.name(), target.runtimeID()));
            }
        });
    }
    ...
    public void initialize() {
        ...
        loadFromImage(tracker1, "photo1.jpg", "photo1");
